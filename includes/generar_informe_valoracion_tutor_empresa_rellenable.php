  ...
  if ($debugPlain || $debugPlainWithMargins) {
    ...
    if ($debugFakeData) {
      ...
      foreach ($ras as $raRow) {
        ...
        $rasRowsHtml .= '<td class="check-cell"><input type="checkbox" name="ra_' . $raIndex . '_superado" value="1" class="checkbox-field"></td>';
        $rasRowsHtml .= '<td class="check-cell"><input type="checkbox" name="ra_' . $raIndex . '_no_superado" value="1" class="checkbox-field"></td>';
        $rasRowsHtml .= '</tr>';
      }

      if ($rasRowsHtml === '') {
        $rasRowsHtml = '<tr><td></td><td></td><td class="check-cell"><input type="checkbox" name="ra_1_superado" value="1" class="checkbox-field"></td><td class="check-cell"><input type="checkbox" name="ra_1_no_superado" value="1" class="checkbox-field"></td></tr>';
      }
