...
<section class="panel"><div class="panel-header panel-header-with-actions"><h3>Configuración</h3><div class="panel-header-actions entity-form"><label>Curso escolar<select id="id_curso_escolar"><?php foreach ($courses as $c): ?><option value="<?php echo (int)$c['id_curso_escolar']; ?>" <?php echo (int)$c['id_curso_escolar']===$selectedCourse?'selected':''; ?>><?php echo htmlspecialchars((string)$c['curso_escolar'],ENT_QUOTES,'UTF-8'); ?></option><?php endforeach; ?></select></label><label>Grupo<select id="id_grupo"><?php foreach ($groups as $g): ?><option value="<?php echo (int)$g['id_grupo']; ?>" <?php echo (int)$g['id_grupo']===$selectedGroup?'selected':''; ?>><?php echo htmlspecialchars((string)$g['grupo'],ENT_QUOTES,'UTF-8'); ?></option><?php endforeach; ?></select></label></div></div>
