...
<header class="header"><div><h1>Editar horarios de grupos</h1><p class="subheading">Selecciona curso y grupo para configurar la cuadrícula semanal.</p></div><div class="header-actions"><a class="primary-button" href="horarios.php?id_curso_escolar=<?php echo (int) $selectedCourse; ?>&id_grupo=<?php echo (int) $selectedGroup; ?>">Volver a horarios</a></div></header>
